...
class ChatServiceClient extends $grpc.Client {
  ...
  static final _$subscribe = $grpc.ClientMethod<$1.Empty, $2.Chat>(
      '/service.ChatService/Subscribe',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.Chat.fromBuffer(value));
  ...
  $grpc.ResponseStream<$2.Chat> subscribe($1.Empty request,
      {$grpc.CallOptions options}) {
...
abstract class ChatServiceBase extends $grpc.Service {
  $core.String get $name => 'service.ChatService';
  ...
  ChatServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.StringValue, $1.Empty>(
        ...
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.Empty, $2.Chat>(
        'Subscribe',
        subscribe_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $1.Empty.fromBuffer(value),
        ($2.Chat value) => value.writeToBuffer()));
  }
  ...
  $async.Stream<$2.Chat> subscribe_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async* {
    yield* subscribe(call, await request);
  }

  $async.Future<$1.Empty> send($grpc.ServiceCall call, $0.StringValue request);
  $async.Stream<$2.Chat> subscribe($grpc.ServiceCall call, $1.Empty request);
}
